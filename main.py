...
sights = {
    "호치민 시티": [
        ["벤탄 시장", "전통 시장과 기념품 쇼핑의 명소"],
        ["노틀담 대성당", "프랑스 식민지 양식의 대표 성당"],
        ["전쟁 박물관", "베트남 전쟁 관련 전시"],
        ["사이공 스카이덱", "시내 전경을 볼 수 있는 전망대"]
    ],
    "달랏 (Da Lat)": [
        ["사랑의 계곡", "자연과 로맨틱한 풍경이 어우러진 명소"],
        ["달랏 기차역", "프랑스식 유럽풍 역사 건물"],
        ["쭈옌람 사원", "고요한 호수와 함께하는 불교 사찰"],
        ["달랏 야시장", "현지 음식과 쇼핑을 즐길 수 있는 밤시장"]
    ],
    "무이네 (Mui Ne)": [
        ["화이트 샌듄", "사막 같은 하얀 모래 언덕"],
        ["레드 샌듄", "붉은 빛 모래언덕에서 썰매 체험"],
        ["요정의 개울", "붉은 흙과 계곡이 독특한 경관"],
        ["무이네 해변", "카이트서핑과 해수욕 명소"]
    ],
    "껀터 (Can Tho)": [
        ["깔락 플로팅 마켓", "배에서 이루어지는 전통 시장"],
        ["빈뚜이 사원", "메콩델타 지역의 불교 사원"],
        ["껀터 다리", "강을 잇는 랜드마크 대교"],
        ["껀터 야시장", "현지 음식과 길거리 공연이 있는 시장"]
    ],
    "붕따우 (Vung Tau)": [
        ["예수상", "산 정상의 거대한 예수 동상"],
        ["백사장 해변", "현지인과 관광객이 찾는 인기 해변"],
        ["등대 전망대", "시내와 바다를 한눈에 볼 수 있는 곳"],
        ["호 세네탄 사원", "불교 문화 유산"]
    ],
    "푸꾸옥 섬 (Phu Quoc)": [
        ["사오 해변", "하얀 모래와 에메랄드빛 바다"],
        ["푸꾸옥 야시장", "신선한 해산물과 기념품 가득"],
        ["딘까우 사원", "해안 절벽 위에 세워진 작은 사원"],
        ["빈펄 사파리", "아이와 함께 즐기는 동물원 및 수족관"]
    ]
}
